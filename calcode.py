...
root = Tk()
root.title("Code Singer Scientific Calculator")
...
lblDisplay = Label(calc, text = "Code Singer Scientific Calculator",
...
menubar.add_cascade(label = 'Change Mode', menu = filemenu)
